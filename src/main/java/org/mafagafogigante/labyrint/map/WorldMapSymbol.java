...
import org.mafagafogigante.labyrint.game.LocationDescription;
...
class WorldMapSymbol {
  ...
  private static final WorldMapSymbol HERO_SYMBOL = new WorldMapSymbol("Vy", '@', Color.WHITE);
  private static final WorldMapSymbol NOT_YET_GENERATED_SYMBOL = new WorldMapSymbol("Neznáma oblast", '~', Color.GRAY);
