...
import org.mafagafogigante.labyrint.entity.creatures.HeroUtils;
import org.mafagafogigante.labyrint.entity.items.Item;
import org.mafagafogigante.labyrint.game.BlockedEntrances;
...
import org.mafagafogigante.labyrint.stats.TypeOfCauseOfDeath;
  ...
  static {
    ...
    putSpell(new Spell("PERCEIVE", "Perceive") {
      ...
      public void operate(Hero hero, String[] targetMatcher) {
        ...
        string.append("Soustředíte se a dovolíte, aby vám kouzla ukázala, co vašim očím mohlo uniknout...\n");
